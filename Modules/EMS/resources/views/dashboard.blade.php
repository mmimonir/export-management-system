...
@section('title', 'EMS Dashboard - Export Management System')

@section('page-title', 'EMS Dashboard')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">EMS</li>
@endsection
            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('ems.product.create') }}" class="btn btn-sm btn-primary">
                ...
                <div class="card-footer">
                    <a href="{{ route('ems.product.index') }}" class="btn btn-sm btn-outline-primary">View All Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card text-bg-primary">
                <div class="card-body">
                    ...
                    <a href="{{ route('ems.product.create') }}" class="btn btn-light btn-sm">Add New Product</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 mb-3">
                            <a href="{{ route('ems.product.create') }}" class="btn btn-block btn-outline-primary">
                                <i class="bi bi-plus-circle me-2"></i> New Product
                            </a>
                        </div>
                        <div class="col-6 mb-3">
                            <a href="{{ route('ems.product.index') }}" class="btn btn-block btn-outline-success">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            console.log('EMS Dashboard loaded successfully');
        });
    </script>
@endpush
